...
**Optionally** you can also publish the config file with:
...
To learn more about each plugin, please refer to their own documentation pages further below.
...
For detailed information about the knowledge base panel and how to customize it, check out its own [documentation here](https://github.com/GuavaCZ/filament-knowledge-base/blob/main/docs/v2/knowledge-base-plugin.md).
